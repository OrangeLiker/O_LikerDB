package org.Oliker.mydb.backend;

import org.Oliker.mydb.backend.dm.DataManager;
import org.Oliker.mydb.backend.server.Server;
...
import org.Oliker.mydb.backend.vm.VersionManager;
import org.Oliker.mydb.backend.vm.VersionManagerImpl;
...
public class Launcher {
    ...
    private static void createDB(String path) {
        TransactionManager tm = (TransactionManager) TransactionManager.create(path);
        DataManager dm = DataManager.create(path, DEFALUT_MEM, tm);
        VersionManager vm = (VersionManager) new VersionManagerImpl(tm, dm);
    ...
    private static void openDB(String path, long mem) {
        TransactionManager tm = (TransactionManager) TransactionManager.open(path);
